...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOA, TIM_ENC1_A_Pin|TIM_ENC1_B_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA5     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(GPIOA, TIM_ENC2_B_Pin|TIM_ENC2_A_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(GPIOB, TIM_FAN_PWM_Pin|TIM_FAN_INDEX_Pin);

    HAL_GPIO_DeInit(ENC1_A_SPEED_GPIO_Port, ENC1_A_SPEED_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(ENC2_A_SPEED_GPIO_Port, ENC2_A_SPEED_Pin);
